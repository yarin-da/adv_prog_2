...
namespace Adv_Prog_2.model.data
{
    class AnomalyAnalyzer
    {
        ...
        private string flightFilePath = null;
        #endregion
        ...
        private void LoadDetectorAndAnomaliesVector()
        {
            ...
            if (HasData)
            {
                ...
                detectTs = CreateTimeSeries(flightFilePath, titles, titles.Length);
        ...
        public float[] GetFunctionData(string feature)
        {
            if (detector != IntPtr.Zero && detectTs != IntPtr.Zero && HasData)
            {
                int size = 0;
